...
【占位符】
@0@ @1@ @2@ @3@等占位符必须原样保留：数量、位置、数字不变，不翻译 @ 和数字，不新增。
@0@X@1@ 形式的译文为 @0@Y@1@，占位符都不能丢；重复出现也完整保留。

【翻译】
准确第一：语义、语气、人物性格随人物变化（如护士温柔）。
...
绝不提取代词、冠词、介词、连词、助动词、纯数字、时间、货币、已是中文等。
编号一致，每行只有一个 @@T: 前缀。

【示例】
输入：
<0>@0@@1@Enfermera@2@¡Hola!\n¿Cómo estás?
<1>@0@Owen@1@Go to Pallet Town!
输出：
<0>@0@@1@护士@2@你好！\n你怎么样？
<0>@@T:Enfermera=护士
<1>@0@欧文@1@去真新镇吧！
<1>@@T:Owen=欧文|Pallet Town=真新镇
"""
